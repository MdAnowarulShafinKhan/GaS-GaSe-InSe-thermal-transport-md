#!/usr/bin/env python3
# =============================================================================
#  Monolayer GaSe - harmonic phonon dispersion + total/projected phonon DOS
# =============================================================================
#
#  Method:
#    1. Build the four-atom X-M-M-X primitive cell.
#    2. Relax the in-plane cell and atomic coordinates with the GaSe Tersoff EIAP.
...
#                    a0       c        h       d_M-M    d_M-X
#    DFT            3.819   25.000    4.833    2.474    2.501
#    Tersoff EIAP   4.087   23.750    4.479    2.228    2.614
#
...
#      python gase_phonon_dispersion_pdos.py
# =============================================================================
...
M_ELEMENT = "Ga"
X_ELEMENT = "Se"
POTENTIAL = "GaSe.tersoff"
ELEMENTS = [M_ELEMENT, X_ELEMENT]  # LAMMPS type 1 = M, type 2 = X
MASSES = {1: 69.723000, 2: 78.960000}  # atomic mass units

# EIAP equilibrium geometry from Supporting Information Table S7.
A_GUESS = 4.087000       # in-plane lattice constant a0 (A)
M_M_GUESS = 2.228000    # vertical metal-metal distance d_M-M (A)
THICK_GUESS = 4.479000   # outer X-X monolayer thickness h (A)
D_MX_REFERENCE = 2.614000  # nearest metal-chalcogen bond d_M-X (A)

# The paper reports c = 23.750 A for its relaxed EIAP cell. Here 25 A is used
...
def build_primitive():
    """Build the four-atom Se-Ga-Ga-Se primitive cell."""
    a = A_GUESS
    z_m = M_M_GUESS / 2.0
    z_x = THICK_GUESS / 2.0
